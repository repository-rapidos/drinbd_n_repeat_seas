...
"""
Dans cette v2 nous avons tout simplement écarté le paramètre: parity
"""
...
def download_model(pair, test_nbr):
	assert pair.upper() in pairs_list, f'The pair your enter "{pair}" must be within the list:{pairs_list}'
	model_cloud_filepath = model_reference_cloud_path + models_filenames[pair.upper()]
