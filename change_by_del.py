...
def manage(account,
	...
	### DROP LAST ROW TO STABILIZE CLOSE:
	...
	if int(reference_date_open_close.tail(1)['date_from'].tolist()[-1].split(" ")[1].split(":")[1]) == os_minute_now:
		...
		if use_tests_53_models_nbr is None:
			...
			df_results_last_row = df_results.tail(1)
			df_results_last_row_filename = get_signals + "change_by_del_" + str(int(start_runing_timestamp)) + ".csv"
